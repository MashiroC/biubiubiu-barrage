var barrageWall={
    ...
    init:function(option){
        ...
        if (window.WebSocket) {
            socket =new WebSocket("wss://wx.yyeke.com/bigscreennetty/screen");
            // socket = new WebSocket("ws://localhost:8081/screen");
